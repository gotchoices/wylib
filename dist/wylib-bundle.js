...
var _local = __webpack_require__(/*! ./local.js */ "./src/local.js");

var _local2 = _interopRequireDefault(_local);

var _top = __webpack_require__(/*! ./top.js */ "./src/top.js");
...
exports.default = {
  ...
  methods: {
    lang: function lang(key, title, defVal) {
    ...
    siteChange: function siteChange(site) {
      ...
      if (this.pw.checked) _local2.default.check(site); //If this is not the first run, check the new site storage situation
    },
    ...
    saveStateAs: function saveStateAs() {
      ...
      this.top.query('!appStatePrompt', dewArr, resp, function (tag) {
        if (tag == 'diaYes') _state2.default.saveAs(_this3.tag, resp.t, resp.h, _this3.state, _this3.top.error, function (ruid) {
    ...
    defaultState: function defaultState() {
      ...
      this.top.confirm('!appDefault', function (tag) {
        if (tag == 'diaYes') {
          ...
          _local2.default.reset();
        }
      });
    },
    beforeUnload: function beforeUnload() {
      //console.log("About to unload.  Saving state:", JSON.stringify(this.state))
      if (this.persistent) _local2.default.set(this.tagTitle, this.state, true);else _local2.default.reset(this.tagTitle);
    },
    submitPW: function submitPW(ev) {
      _local2.default.pw(ev);
    },
    initApp: function initApp() {
      var _this5 = this;

      //Call when app ready to run
      _wyseman2.default.register(this.id + 'wm', 'wylib.data', function (data, err) {
        if (data.msg) _this5.wm = data.msg;
        //console.log("App wm:", this.wm)
        if (!_this5.pw.checked) _local2.default.check(); //If this is the first run, we should now have enough wm data for the dialog to work
      });

      var savedState = _local2.default.get(this.tagTitle);
  ...
  created: function created() {
    ...
    _local2.default.init(this, this.pw, this.tag, function (isReady) {
...
var Pr = __webpack_require__(/*! ./prefs */ "./src/prefs.js");
...
var _fileSaver = __webpack_require__(/*! file-saver */ "file-saver");
...
var SaltLength = 128; //For signing with RSA-PSS
...
exports.default = {
  ...
  computed: {
    ...
    tryView: function tryView() {
      return this.tryTimer ? this.retryIn : null;
    },
  ...
  methods: {
    bwm: function bwm(key, extend) {
      var theLang = this.wm[key] || WmDefs[key] || {};
      if (extend) theLang.help += ' (' + extend + ')';
      return theLang;
    },
    lang: function lang(key, title) {
    ...
    togConn: function togConn(ev) {
      ...
      if (this.selectedSite && !ev.shiftKey) this.$nextTick(function () {
        _this.connectSite();
      });
    },
    ...
    keyCheck: function keyCheck(site, cb) {
      ...
      if (site.priv) cb(site);else if (Crypto) {
        //Crypto API found
        //console.log("  generating key:")
        Crypto.generateKey(KeyConfig, true, ['sign', 'verify']).then(function (keyPair) {
          site.priv = keyPair.privateKey;
          return Crypto.exportKey('spki', keyPair.publicKey);
        }).then(function (pubKey) {
          site.pub = _common2.default.buf2hex(pubKey);
          //console.log("  pub:", site.pub)
          cb(site);
        }).catch(function (err) {
          console.log("Error:", err.message);
          _this2.top().error(_this2.bwm('conCryptErr', err.message));
        });
    ...
    userCheck: function userCheck(site, cb) {
      ...
      if (this.db) {
        ...
        site.db = _common2.default.buf2hex(Buffer(JSON.stringify(this.db)));
      }
      if (site.user) cb();else this.top().input(this.bwm('conUsername'), function (ans, data) {
    ...
    signCheck: function signCheck(site, cb) {
      ...
      else _common2.default.ajax(window.location.origin + '/clientinfo', function (data) {
          var encoder = new TextEncoder(),
              ip = data.ip,
              cookie = data.cookie,
              userAgent = data.userAgent,
              date = data.date,
              message = JSON.stringify({ ip: ip, cookie: cookie, userAgent: userAgent, date: date }); //Rebuild in this same order in backend!
          //console.log("  Client data:", data, date, site.priv)
          if (Crypto) {
            Crypto.sign(SignConfig, site.priv, encoder.encode(message)).then(function (sign) {
              //console.log("  signed:", sign, date)
              site.sign = _common2.default.buf2hex(sign);
              site.date = date;
              cb();
            }, function (err) {
              //console.log("Error:", err.message)
              _this4.top().error(_this4.bwm('conCryptErr', err.message));
            });
          } else if (site.proto == 'ws:') cb(site);
        });
    },
      ...
      this.keyCheck(site, function () {
        return _this5.userCheck(site, function () {
          _this5.signCheck(site, function () {
            ...
            _wyseman2.default.connect(site);
            _local2.default.set(LastKey, { host: site.host, port: site.port, user: site.user });
          });
        });
      });
    },
    delSites: function delSites(ev) {
      ...
      _local2.default.set(SiteKey, this.sites);
    },
    importKeys: function importKeys(ev) {
      var _this6 = this;

      //Set/get ticket value
      _common2.default.fileReader(ev.target, 1500, function (fileData) {
        //console.log("Keys data:", fileData)
        var eatObject = function eatObject(obj) {
          var _loop = function _loop(keyType) {
            var site = obj[keyType];
            if (keyType == 'ticket' || keyType == 'login') {
              var oldIdx = _this6.sites.findIndex(function (el) {
              ...
              if (oldIdx >= 0) _this6.sites.splice(oldIdx, 1, site); //Replace old key
              else _this6.sites.splice(0, 0, site); //Add in new
              if (site.jwk) Crypto.importKey('jwk', site.jwk, KeyConfig, true, ['sign']).then(function (priv) {
                site.priv = priv;
                _local2.default.set(SiteKey, _this6.sites);
              }, function (err) {
                console.log("Error:", err.message);
                _this6.top().error(_this6.bwm('conCryptErr', err.message));
              });
            }
          };
        ...
        if (Array.isArray(fileData)) fileData.forEach(function (el) {
          eatObject(el);
        });else if ((typeof fileData === 'undefined' ? 'undefined' : _typeof(fileData)) == 'object') eatObject(fileData);
      });
    },
    exportKeys: function exportKeys(v) {
      var _this7 = this;

      //Write selected keys to a file
      console.log("Export:");
      var expData = [],
          expKeys = [] //Make local copy of the keys
      ,
          writeToFile = function writeToFile(keyData) {
        if (keyData.length > 0) _this7.top().input(_this7.bwm('conExpFile'), function (ans, file) {
          if (ans == 'diaYes' && file.value) {
            ...
            var blob = new Blob([JSON.stringify(keyData)], { type: "text/plain;charset=utf-8" });
            _fileSaver2.default.saveAs(blob, file.value);
          }
        }, 'keys.json');
      };
      for (var i = this.sites.length - 1; i >= 0; i--) {
      ...
      var _loop2 = function _loop2(_i) {
        ...
        Crypto.exportKey('jwk', expKeys[_i].priv).then(function (keyData) {
          ...
          console.log("Error:", err.message);
          _this7.top().error(_this7.bwm('conCryptErr', err.message));
        });
      };

      for (var _i = 0; _i < expKeys.length; _i++) {
        _loop2(_i);
      }
    },
  ...
  created: function created() {
    ...
    _wyseman2.default.register(this.id + 'wm', 'wylib.data', function (data, err) {
      if (data.msg) _this8.wm = data.msg;
    });
  },
  ...
  mounted: function mounted() {
    ...
    var last = _local2.default.get(LastKey);
    this.sites = _local2.default.get(SiteKey) || []; //Get our list of favorites
    this.sites.forEach(function (site) {
      if (site.jwk) Crypto.importKey('jwk', site.jwk, KeyConfig, true, ['sign']).then(function (priv) {
        site.priv = priv;
        if (site.host == last.host && site.port == last.port && site.user == last.user) _this9.connectSite(site); //Auto reconnect to last connected site
      }, function (err) {
        _this9.top().error(_this9.bwm('conCryptErr', err.message));
      });
    });
    ...
    _wyseman2.default.request('_main', 'connect', { stay: true }, function (addr) {
      ...
      _this9.$emit('site', _this9.currentSite = addr); //Tell my parent about connection change
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      valid: false,
      lastView: null,
      mdewBus: new _bus2.default.messageBus(this),
      subBus: new _bus2.default.messageBus(this),
  ...
  methods: {
    loadRec: function loadRec() {
      ...
      var dews = [];this.mdewConfig.forEach(function (el, ix) {
        if (_this5.viewMeta.pkey.includes(el.field)) {
      ...
      this.top().query('!dbeLoadPrompt', dews, resp, function (tag) {
        ...
        if (tag == 'diaYes') _this5.load(resp);
      });
    },
    ...
    load: function load(where) {
      ...
      this.dirty = false;
      this.valid = true;
      this.dataRequest('tuple', { where: where, fields: '*' }, false);
    },
    insert: function insert() {
      ...
      if (this.master) {
        var _master = this.master,
            view = _master.view,
            values = _master.values,
            keys = _master.keys,
            hisCols = keys.join(','),
            keyLink = this.viewMeta.fkeys.find(function (el) {
          return el.table == view && el.foreign.join(',') == hisCols;
        });
        //console.log("insert:", fields, "keyMaster:", this.master, hisCols, "keyLink:", keyLink)

        if (keyLink) keyLink.columns.forEach(function (key, idx) {
      ...
      this.dataRequest('insert', { fields: fields });
    },
    update: function update() {
      var fields = this.mdewBus.notify('userData')[0];
      console.log("Update data:", fields);
      this.dataRequest('update', { fields: fields, where: this.keyWhere() }, true);
    },
    ...
    addWin: function addWin(view) {
      ...
      _common2.default.addWindow(this.state.subs, { posted: true, client: { dbView: view } }, this, true);
    },
    closeWin: function closeWin(idx, reopen) {
      _common2.default.closeWindow(this.state.subs, idx, this, reopen);
    },
    reportQuery: function reportQuery(request, data) {
      var _this8 = this;

      //Requests from a launched report
      ...
      if (!request || request == 'pKey') {
        ...
        this.mdewConfig.forEach(function (el) {
          ...
          var key = el.field;
          if (key in data && data[key] != _this8.dbData[key]) uData[key] = data[key];
        });
    ...
    metaListen: function metaListen() {
      ...
      var zid = this.id + 'cv';
      if (this.lastView) _wyseman2.default.register(zid, this.lastView); //Un-register any prior view
      if (this.state.dbView) _wyseman2.default.register(this.id + 'cv', this.state.dbView, function (data) {
        ...
        _this9.lastView = _this9.state.dbView;

        var lang = { title: _this9.wm.dbeMenu.title + ': ' + data.title, help: _this9.state.dbView + ':\n' + data.help };
        _this9.$parent.$emit('customize', lang, 'dbe:' + _this9.state.dbView, false, function () {
          return _this9.dirty;
        });

        if (_this9.metaStyles.actions) _this9.metaStyles.actions.forEach(function (act) {
          //Make menu options for any actions associated with this view
          _this9.top().registerDialog(['action', _this9.state.dbView, act.name].join(':'), function (dia, info) {
            //console.log("Dbe got action callback:", dia, act, info)
            return _this9.top().actionLaunch(_this9.state.dbView, act, info, _this9.reportQuery);
          });
        });
      });
    }
  ...
  created: function created() {
    ...
    _wyseman2.default.register(this.id + 'wm', 'wylib.data', function (data, err) {
      if (data.msg) _this10.wm = data.msg;
    });
    this.metaListen();
  },
  ...
  mounted: function mounted() {
    ...
    if (this.bus) this.bus.register(this.id, function (msg, data) {
      ...
      if (msg == 'load') return _this12.load(data);
    });
  },
...
exports.default = {
  ...
  computed: {
    ...
    dockConfig: function dockConfig() {
      ...
      return [{ idx: 'lod', lang: this.wm.dbpLoad, call: function call(ev) {
          ...
          return _this.reload();
        }, icon: 'spinner', shortcut: true }, { idx: 'fil', lang: this.wm.dbpFilter, call: this.loadBy, icon: 'filter', shortcut: true, toggled: this.state.filter.posted }, { idx: 'edi', lang: this.wm.dbe, call: this.editTog, icon: 'pencil', shortcut: true, toggled: this.state.edit.posted }, { idx: 'ald', lang: this.wm.dbpAutoLoad, call: this.autoTog, icon: 'truck', type: 'checkbox', toggled: this.state.autoLoad, input: this.autoLoadValue }, { idx: 'prv', lang: this.wm.dbpPrev, call: this.prev, icon: 'arrowup', shortcut: true }, { idx: 'nxt', lang: this.wm.dbpNext, call: this.next, icon: 'arrowdown', shortcut: true }, { idx: 'dec', lang: this.wm.dbpDefault, call: this.defColumns, icon: 'sun' },
    ...
    mlbConfig: function mlbConfig() {
      ...
      if (this.viewMeta) this.viewMeta.columns.forEach(function (meta) {
        ...
        var defWidth = void 0,
            key = meta.col,
            col = _this3.state.grid.columns.find(function (e) {
          return e.field == key;
        });
  ...
  methods: {
    ...
    load: function load(spec) {
      ...
      _wyseman2.default.request('dbp_' + this._uid, 'select', Object.assign({ view: this.state.dbView, fields: '*' }, spec), function (data, err) {
        ...
        if (err) _this5.top().error(err);else _this5.gridData = data;
        if (_this5.state.edit.posted && _this5.state.autoLoad) _this5.executeRows();
      });
      this.lastSpec = spec;
    },
    ...
    metaListen: function metaListen() {
      ...
      var zid = this.id + 'cv';
      if (this.lastView) _wyseman2.default.register(zid, this.lastView); //Un-register
      if (this.state.dbView) _wyseman2.default.register(this.id + 'cv', this.state.dbView, function (data, err) {
        if (err) {
          _this9.top().error(err);return;
        }
        //console.log("Dbp got metadata for:", this.state.dbView, data)
        _this9.viewMeta = data;
        var title = (_this9.wm.dbp ? _this9.wm.dbp.title : '') + ': ' + data.title;
        _this9.$parent.$emit('customize', { title: title, help: _this9.state.dbView + ':\n' + data.help }, 'dbp:' + _this9.state.dbView);
      });
    },
    followMaster: function followMaster() {
      ...
      if (keyLink) {
        var where = {};
        keyLink.columns.forEach(function (key, idx) {
  ...
  watch: {
    ...
    'state.file.posted': function stateFilePosted(newVal, oldVal) {
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      if (_this12.state.edit && _this12.state.edit.posted) _this12.editPosts = 1; //What was posted before we quit
      if (_this12.state.filter && _this12.state.filter.posted) _this12.filtPosts = 1;
      //console.log('Was loaded, reload?', this.id, this.state.loaded)
      if (_this12.state.loaded > 0) //If state says we had data loaded before, reload now
        _this12.reload();else if (_this12.bus) _this12.followMaster();
    });
  }
...
exports.default = {
  ...
  computed: {
    ...
    mapValue: function mapValue() {
      return this.value != null && _typeof(this.value) == 'object' ? JSON.stringify(this.value) : this.value;
    },
  ...
  methods: {
    input: function input(ev) {
      ...
      if (this.state.style == 'file' && ev.target.files) {
  ...
  beforeMount: function beforeMount() {
    ...
    if (this.bus) this.bus.register(this.field, function (msg, data) {
      ...
      if (msg == 'clear') return _this.clear();else if (msg == 'set') return _this.set(_this.mapValue);
    });
  },
...
exports.default = {
  ...
  computed: {
    ...
    message: function message() {
      ...
      if (_typeof(this.state.message) == 'object') return this.state.message.title;
    },
  ...
  created: function created() {
    ...
    _wyseman2.default.register(this.id + 'wm', 'wylib.data', function (data, err) {
      if (data.msg) _this2.wm = data.msg;
    });
  },
...
var _wyseman = __webpack_require__(/*! ./wyseman */ "./src/wyseman.js");
...
exports.default = {
  ...
  methods: {
    addWin: function addWin() {
      ...
      _common2.default.addWindow(this.state.windows, newState, this, true);
    },
    closeWin: function closeWin(idx, reopen) {
      _common2.default.closeWindow(this.state.windows, idx, this, reopen);
    },
    importFile: function importFile(ev) {
      var _this = this;

      _common2.default.fileReader(ev.target, 1000, function (data) {
        //console.log("Launch got file import:", data)
        var spec = { view: _this.launchData.import + '(jsonb)', params: [data] };
        _wyseman2.default.request('import.' + _this.id, 'tuple', spec, function (res, err) {
  ...
  created: function created() {
    ...
    _wyseman2.default.register(this.id + 'vm', this.view, function (data, err) {
      if (err) {
...
exports.default = {
  ...
  computed: {
    ...
    isBinary: function isBinary() {
      return this.state.oper != 'null' && this.state.oper != 'true';
    },
  ...
  beforeMount: function beforeMount() {
    ...
    if (this.bus) this.bus.register(this.id, function (msg, data) {
      if (msg == 'userData') {
        ...
        return _this2.dewBus.notify(msg, data); //Pass down to children
      }
    });
...
exports.default = {
  ...
  methods: {
    ...
    execute: function execute(cb, ev) {
    ...
    slickColumns: function slickColumns() {
      ...
      var _loop = function _loop(field) {
        ...
        if (!col) {
          ...
          col = { field: field, order: conf.order, width: conf.width || _this.pr.mlbDefWidth, visible: conf.visible };
  ...
  beforeMount: function beforeMount() {
    ...
    var _loop3 = function _loop3(field) {
      ...
      if (!_this6.state.columns.find(function (e) {
        ...
        _this6.state.columns.push({ field: field, order: con.order, width: con.width || _this6.pr.mlbDefWidth, visible: con.visible });
    };
...
exports.default = {
  name: 'wylib-pop',
  components: { 'wylib-modal': _modal2.default, 'wylib-dialog': _dialog2.default },
  props: {
    state: { type: Object, default: function _default() {
        return {};
      } },
...
exports.default = {
  ...
  mounted: function mounted() {
    ...
    this.$parent.$emit('customize', action.lang, this.state.name, true, function () {
      return _this2.dirty;
    });
...
var _crossref = __webpack_require__(/*! ./crossref.js */ "./src/crossref.js");

var _crossref2 = _interopRequireDefault(_crossref);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

//import DiffPatch from 'jsondiffpatch'

var IconBin = 'data:image/svg+xml,<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'16px\' height=\'16px\' viewBox=\'0 0 32 32\'>' + _icons2.default.code.bin + '</svg>'; //
//
//
//
//
...
customElements.define('x-r', _crossref2.default);
//DiffPatch.create({
...
exports.default = {
  ...
  computed: {
    ...
    dragCursor: function dragCursor() {
      var cur = 'move';
      if (this.dragType == 'none') cur = 'no-drop';else if (this.dragType == 'trash') cur = iconBin;else if (this.dragType == 'copy') cur = 'copy';
      return cur;
    },
  ...
  methods: {
    lang: function lang(key) {
      var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'help';
      var defVal = arguments[2];

      return this.wm[key] ? this.wm[key][type] : defVal;
    },
    change: function change(ev) {
      if (this.bus) this.bus.master.$emit('dirty');else this.dirty = true;
    },
    ...
    targetChange: function targetChange(ev) {
      ...
      if (this.bus) this.bus.master.$emit('xref', ev); //Send up to the chief
      else if (this.iAmChief) this.processXrefs(ev);
    },
    ...
    clear: function clear() {
      ...
      //Empty workspace
      this.top().confirm('!sdcClearAsk', function (ans) {
        if (ans == 'diaYes') {
          var tmpState = _common2.default.clone(_this2.stateTpt);
    ...
    export: function _export() {
      ...
      var resp = { file: 'document.json' },
          dews = [{ field: 'file', lang: '!sdcExportAsk', styles: { style: 'ent', focus: true } }, { field: 'pretty', lang: '!sdcExportFmt', styles: { style: 'chk' } }];
      this.top().query('!sdcExportAsk', dews, resp, function (ans) {
        if (ans == 'diaYes' && resp.file) {
          ...
          _fileSaver2.default.saveAs(blob, resp.file);
        }
      });
    },
    import: function _import() {
      ...
      var resp = {},
          dews = [{ field: 'files', lang: this.wm.sdcImportAsk, styles: { style: 'file', focus: true } }];
      this.top().query('!sdcImportAsk', dews, resp, function (ans) {
        ...
        if (ans == 'diaYes' && resp.files && resp.files.length >= 1) {
          ...
          reader.onload = function () {
            ...
            _common2.default.stateCheck(_this4, data, true);
    ...
    addSubs: function addSubs(idx, addArr) {
      ...
      addArr.forEach(function (el) {
        ...
        };_this5.state.subs.splice(idx++, 0, el);
      });
    },
    addChild: function addChild(ev) {
      //Add empty sub-paragraph at end
    ...
    zoneOver: function zoneOver(ev) {
      ...
      this.dragOver = true; //Illuminate me (the drag target)
      dragTarget = this; //And remember who I am
      if (this == dragee && !ev.shiftKey) dragee.dragType = 'none';else if (ev.shiftKey) dragee.dragType = this.iAmChief ? 'none' : 'copy';else if (this.iAmChief) dragee.dragType = 'trash';else dragee.dragType = 'move';
    ...
    dragDrop: function dragDrop(ev) {
      ...
      var dragType = dragTarget.dragType;
      dragTarget.dragType = 'move';
      dragTarget.dragOver = false; //Clear target highlighting
      //console.log("Zone drop:", this.secNumber, dragTarget.secNumber, dragType)
      if (dragTarget == this && dragType != 'copy') return; //Aborted drag, over myself
      var stateCopy = _common2.default.clone(this.state);
      if (dragType == 'trash' || dragType == 'move') this.$emit('delete'); //Delete me
      if (dragType == 'copy' || dragType == 'move') dragTarget.$emit('add', [stateCopy]);
    },
  ...
  created: function created() {
    ...
    _wyseman2.default.register(this.id + 'wm', 'wylib.data', function (data, err) {
      if (data.msg) _this6.wm = data.msg;
    });
  },
  beforeMount: function beforeMount() {
    var _this7 = this;
    ...
    if (this.iAmChief) {
      this.subBus = new _bus2.default.messageBus(this); //Parent
      this.$on('xref', function (ev) {
        _this7.processXrefs(ev);
      }); //Xref events from subs
    ...
    if (this.subBus) this.subBus.register(this.id, function (msg, data) {
      ...
      if (msg == 'edit') _this7.state.edit = true;else if (msg == 'preview') _this7.state.edit = false;else if (msg == 'markup' && _this7.state.edit) _this7.markTextArea(data);else if (msg == 'check') _common2.default.stateCheck(_this7, _this7.state, true);
    });
  },
  mounted: function mounted() {
    if (this.iAmChief) {
...
var nodeBus = new _bus2.default.eventBus(undefined); //Discover vms by a given tag
      ...
      this.$refs.node.forEach(function (vm1, ix1) {
        ...
        _this2.$refs.node.forEach(function (vm2, ix2) {
          if (ix1 != ix2) {
            ...
            ,
                push = Math.min(_this2.state.pushForce * 800 / Math.pow(mag, 2), maxMove),
                pull = _this2.state.pullForce * mag / 1000000000 //All objects have a little attractive gravity
            ,
                randPull = 0;
            //console.log("bump:", ix1, ix2, rect12, polar12, maxMove, push, aspectBias)

            if (links.includes(vm2.state.tag)) {
              pull += _this2.state.pullForce * Math.pow(mag, 2) / 1000000; //Linked objects have a lot more attraction
              if (Math.random() < 0.02) {
            ...
            forces[ix2] = _vector2.default.add(forces[ix2], { r: push - pull + randPull, a: polar12.a }, aspectBias);
          }
        });
      });
...
exports.default = {
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      dirty: null,
      printable: false,
      repBus: new _bus2.default.eventBus(this),
      winMenu: { client: {} }, client: {} }, _defineProperty(_ref, 'modal', { posted: false }), _defineProperty(_ref, 'stateTpt', { x: null, y: null, posted: false, pinned: false, layer: 10, minim: false, dialogs: {}, reports: {}, height: null, width: null }), _ref;
  },
  provide: function provide() {
    var _this = this;
  ...
  computed: {
    ...
    winMenuConfig: function winMenuConfig() {
      ...
      return [{ idx: 'sav', lang: this.saveTitle, icon: 'upload', call: this.saveState }, { idx: 'sas', lang: wm.winSaveAs, icon: 'upload2', call: this.saveStateAs }, { idx: 'res', lang: wm.winRestore, icon: 'download', menu: this.restoreMenu, layout: ['lang', 'owner', 'access'] }, { idx: 'def', lang: wm.winDefault, icon: 'home', call: this.defaultState }, prElem, { idx: 'top', lang: wm.winToTop, icon: 'arrowup', call: function call() {
          _this2.top.layer(1);
  ...
  methods: {
    ...
    popup: function popup() {
      ...
      var fragment = _common2.default.deepCloneWithStyles(this.$refs.content),
    ...
    saveStateAs: function saveStateAs() {
      ...
      this.top.query('!appStatePrompt', dewArr, resp, function (tag) {
        //console.log("tag", tag)
        if (tag == 'diaYes') _state2.default.saveAs(_this4.stateTag, resp.t, resp.h, _this4.state, _this4.top.error, function (ruid) {
    ...
    storeState: function storeState() {
      ...
      if (this.topLevel && this.stateTag) _local2.default.set(this.stateTag, this.state);
    },
    defaultState: function defaultState() {
      var _this5 = this;

      this.top.confirm(this.wm.winDefault.help, function (tag) {
        if (tag == 'diaYes') {
          _local2.default.set(_this5.stateTag);
    ...
    closeDia: function closeDia(idx, reopen) {
      _common2.default.closeWindow(this.state.dialogs, idx, this, reopen);
    },
  ...
  created: function created() {
    ...
    if (this.topLevel) this.top = new _top2.default(this);
  },
  ...
  beforeMount: function beforeMount() {
    ...
    if (this.topLevel) this.$on('customize', function (lang, tag, print, dirty) {
      ...
      _this9.lang = lang;
      if (tag) _this9.stateTag = tag;
      _this9.printable = print;
      if (dirty) _this9.dirty = dirty;

      _state2.default.listen(_this9.id + 'sl', _this9.stateTag, function (menuData) {
        var _restoreMenu;
        ...
        var menuItems = menuData.map(function (el) {
          return Object.assign(el, { call: function call() {
              Object.assign(_this9.state, _common2.default.clone(el.data));
              _common2.default.stateCheck(_this9);
              _this9.lastLoadIdx = el.idx;
              _this9.lastLoadName = el.lang.title;
            } });
        });
        (_restoreMenu = _this9.restoreMenu).splice.apply(_restoreMenu, [0, _this9.restoreMenu.length].concat(_toConsumableArray(menuItems)));
    ...
    this.$on('report', function (config) {
      ...
      var repTag = config.repTag,
          info = config.info;

      _this9.top.submitDialog(repTag, info);
    });
  },
  ...
  mounted: function mounted() {
    ...
    (0, _interactjs2.default)(this.$el).resizable({ //Set up moving/resizing of windows
      inertia: true,
      margin: 7,
    ...
    if (!this.topLevel) {
      //Find a toplevel where clicks will unpost menus
    ...
    if (this.topLevel) {
      //Hopefully runs after customizations below
      var savedState = _local2.default.get(this.stateTag);
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/mdew.vue?vue&type=style&index=0&lang=scss&":
/*!**************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib??vue-loader-options!./src/mdew.vue?vue&type=style&index=0&lang=scss& ***!
  \**************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/mlb.vue?vue&type=style&index=0&lang=scss&":
/*!*************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib??vue-loader-options!./src/mlb.vue?vue&type=style&index=0&lang=scss& ***!
  \*************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
        ...
        ? _c(
            ...
            [
              _c(
                "button",
                {
                  attrs: { title: _vm.lang("appServer") },
                  on: {
                ...
                [_vm._v(_vm._s(_vm.lang("appServer", 1, "Server")) + ":")]
              ),
              _vm._v(" "),
              _c("span", { attrs: { title: _vm.lang("appServerURL") } }, [
              ...
              _c(
                ...
                [
                  ...
                  _c(
                    "wylib-win",
                    {
                      attrs: { state: _vm.appMenu, pinnable: "true" },
                      on: {
  ...
  return _c("div", { staticClass: "wylib-connect" }, [
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("div", [_vm._v(_vm._s(_vm.lang(_vm.status)))])
      ],
      1
    ),
    _vm._v(" "),
    _c(
      "div",
      { staticClass: "label", attrs: { title: _vm.lang("conTitle") } },
      [_vm._v(_vm._s(_vm.lang("conTitle", 1)) + ":")]
    ),
    _vm._v(" "),
    _c(
      "div",
      { staticClass: "sitelist", attrs: { title: _vm.lang("conTitle") } },
      [
        _c(
          "table",
    ...
    _c(
      "div",
      { staticClass: "label", attrs: { title: _vm.lang("conImport") } },
      [
        _vm._v(_vm._s(_vm.lang("conImport", 1)) + ":"),
        ...
        [
          this.editPosts
            ? _c(
                "wylib-win",
                {
                  attrs: { state: _vm.state.edit, topLevel: "true" },
                  on: {
                    close: function($event) {
          ...
          this.filtPosts
            ? _c(
                "wylib-win",
                {
                  attrs: { state: _vm.state.filter, topLevel: "true" },
                  on: {
                    close: function($event) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _vm.state.component
        ? _c("wylib-" + _vm.stateVar("component", "type"), {
            ref: "component",
            tag: "component",
            attrs: { state: _vm.stateVar("component", "state") },
      ...
      _vm.state.iframe
        ? _c("iframe", {
            ref: "iframe",
            attrs: {
              src: _vm.stateVar("iframe", "src"),
              name: _vm.stateVar("iframe", "name"),
              height: _vm.stateVar("iframe", "width", "100%")
            }
          })
        : _vm._e(),
      _vm._v(" "),
      _vm.state.dews
        ? _c("wylib-mdew", {
            attrs: { config: _vm.state.dews, data: _vm.state.data },
      ...
      _c("div", { staticClass: "controls" }, [
        _vm.launchData && _vm.launchData.import
          ? _c("label", [
              _vm._v(
                "\n        " +
                  _vm._s(_vm.wm.lchImport ? _vm.wm.lchImport.title : null) +
                  ":\n        "
              ),
              _c("input", {
                attrs: {
                  ...
                  accept: "*.json",
                  multiple: "",
                  title: _vm.wm.lchImport ? _vm.wm.lchImport.help : null
                },
        ...
        _c(
          "button",
          {
            attrs: { title: _vm.wm.lchAdd ? _vm.wm.lchAdd.help : null },
            on: { click: _vm.addWin }
          },
          [_vm._v(_vm._s(_vm.wm.lchAdd ? _vm.wm.lchAdd.title : null))]
        )
      ])
    ]),
    _vm._v(" "),
        ...
        return item.menu
          ? _c(
              "wylib-win",
              {
                ...
                ref: "submenu",
                refInFor: true,
                attrs: { state: _vm.state.subs[item.idx], pinnable: "true" },
                on: {
                  close: function($event) {
    ...
    _c(
      ...
      [
        _c(
          "wylib-win",
          {
            attrs: { state: _vm.state.menu, pinnable: "true" },
            on: {
              close: function($event) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "wylib-pop" }, [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "pop-content" }, [_vm._t("default")], 2)
  ])
}
var staticRenderFns = []
render._withStripped = true
      ...
      "div",
      {
        ...
        on: {
          ...
          dragend: function($event) {
            $event.stopPropagation()
            return _vm.dragDrop($event)
          },
          dragover: function($event) {
            $event.stopPropagation()
            return _vm.zoneOver($event)
          },
          dragleave: function($event) {
            $event.stopPropagation()
            return _vm.zoneLeave($event)
          }
        }
      },
      [
        _c(
          ...
          [
            _c(
              ...
              [
                _c("x-r", {
                  ...
                  on: { connect: _vm.targetChange, change: _vm.targetChange }
                }),
                _vm._v(
                  ".\n        " +
                    _vm._s(_vm.lang("sdcTitle", "title", "Title")) +
                    ":\n      "
                )
              ],
              1
            ...
            _c(
              "span",
              { attrs: { draggable: "false", title: _vm.lang("sdcTitle") } },
              [
                _c("input", {
                  directives: [
                    {
                  ...
                  attrs: {
                    ...
                    placeholder: _vm.lang("sdcTitle", "title")
                  },
            ...
            _vm._v(" "),
            _c("span", [
              _vm._v(_vm._s(_vm.lang("sdcTag", "title", "Tag")) + ":")
            ]),
            _vm._v(" "),
            _c(
              "span",
              { attrs: { draggable: "false", title: _vm.lang("sdcTag") } },
              [
                _c("input", {
                  directives: [
                    {
                  ...
                  attrs: { placeholder: _vm.lang("sdcTag", "title") },
            ...
            _vm._v(" "),
            _c("span", { attrs: { draggable: "false" } }, [
              _c(
                "button",
                { staticClass: "input", on: { click: _vm.addChild } },
                [_vm._v("+")]
              )
            ]),
            _vm._v(" "),
            ...
            _c("div", [
              _c("textarea", {
                ...
                attrs: {
                  ...
                  draggable: "false",
                  spellcheck: "spellCheck",
                  title: _vm.lang("sdcText"),
                  placeholder: _vm.lang("sdcText", "title")
                },
        ...
        !_vm.state.edit
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm._l(_vm.state.subs, function(sub, idx) {
          return _c(
            "div",
            { staticClass: "subs" },
            [
        ...
        [
          _vm.topLevel
            ? _c(
                "wylib-win",
                {
                  attrs: { state: _vm.winMenu, pinnable: "true" },
                  on: {
                    close: function($event) {
          ...
          _vm._l(_vm.state.dialogs, function(dia, key) {
            return _c(
              ...
              [_c("wylib-dialog", { attrs: { state: dia.client } })],
              1
            )
          }),
          _vm._v(" "),
          _vm._l(_vm.state.reports, function(rep, key) {
            return _c(
              ...
              {
                key: key,
                attrs: { topLevel: "true", state: rep },
                on: {
                  close: function(r) {
                    _vm.closeRep(key, r)
                  },
                  report: function(v, a, i, k) {
                    _vm.top.actionLaunch(v, a, i, k)
                  }
                }
              },
              [
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/mdew.vue?vue&type=style&index=0&lang=scss&":
/*!**********************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-style-loader!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib??vue-loader-options!./src/mdew.vue?vue&type=style&index=0&lang=scss& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var update = add("d2f00d14", content, false, {});
// Hot Module Replacement
if(false) {}

/***/ }),

/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/mlb.vue?vue&type=style&index=0&lang=scss&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-style-loader!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib??vue-loader-options!./src/mlb.vue?vue&type=style&index=0&lang=scss& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// add the styles to the DOM
var add = __webpack_require__(/*! ../node_modules/vue-style-loader/lib/addStylesClient.js */ "./node_modules/vue-style-loader/lib/addStylesClient.js").default
var update = add("db69c918", content, false, {});
// Hot Module Replacement
if(false) {}
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_button_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_button_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_button_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
module.exports = {
  ...
  stateCheck: function stateCheck(context) {
    ...
    var properties = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : context.stateTpt;
  ...
  clone: function clone(o) {
    //Deep object copy
    var output = Array.isArray(o) ? [] : o == null || o == undefined ? o : {};
    for (var key in o) {
      var v = o[key];
  ...
  buf2hex: function buf2hex(buffer) {
    ...
    var s = '',
        h = '0123456789ABCDEF';new Uint8Array(buffer).forEach(function (v) {
      s += h[v >> 4] + h[v & 15];
    });
    return s;
  },
  hex2buf: function hex2buf(hexStr) {
    return Buffer(hexStr, 'hex');
    //    return new Uint8Array(hexStr.match(/.{2}/g).map(h => parseInt(h, 16)));
  },
  str2buf: function str2buf(str) {
  ...
  deriveKey: function deriveKey(password, salt) {
    ...
    return crypto.subtle.importKey("raw", this.str2buf(password), "PBKDF2", false, ["deriveKey"]).then(function (key) {
  ...
  encrypt: function encrypt(password, plain) {
    ...
    return this.deriveKey(password).then(function (_ref) {
      ...
      return crypto.subtle.encrypt({ name: "AES-GCM", iv: iv }, key, data).then(function (ciphertext) {
        return _this.buf2hex(salt) + ':' + _this.buf2hex(iv) + ':' + _this.buf2hex(ciphertext);
      });
    });
  },
  ...
  decrypt: function decrypt(password, encrypted) {
    ...
    var _encrypted$split$map = encrypted.split(':').map(this.hex2buf),
        _encrypted$split$map2 = _slicedToArray(_encrypted$split$map, 3),
        salt = _encrypted$split$map2[0],
        iv = _encrypted$split$map2[1],
        data = _encrypted$split$map2[2];
    ...
    return this.deriveKey(password, salt).then(function (_ref3) {
      ...
      return _this2.buf2str(new Uint8Array(v));
    });
  }
};
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../node_modules/buffer/index.js */ "./node_modules/buffer/index.js").Buffer))
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_connect_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_connect_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_connect_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_dbe_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_dbe_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_dbe_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_dbp_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_dbp_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_dbp_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_dbs_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_dbs_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_dbs_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_dew_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_dew_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_dew_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_dialog_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_dialog_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_dialog_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_launch_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_launch_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_launch_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
module.exports = {
  init: function init(context, pwState, appTag, cb) {
    ...
    if (appInfo) {
      ...
      var savedCache = this.getLocal(LocalTag + this.appTag);
  ...
  flush: function flush() {
    ...
    if (this.appInfo != null) localStorage.setItem(idx, JSON.stringify(localCache));
  },
  ...
  pw: function pw(ev) {
    ...
    if (this.passPhrase == 'reset' && ev.shiftKey) this.reset();
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_logitem_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_logitem_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_logitem_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_loglist_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_loglist_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_loglist_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_mdew_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../node_modules/vue-style-loader!../node_modules/css-loader/dist/cjs.js!../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../node_modules/sass-loader/lib/loader.js!../node_modules/vue-loader/lib??vue-loader-options!./mdew.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/mdew.vue?vue&type=style&index=0&lang=scss&");
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_mdew_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_mdew_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_mdew_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_mdew_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_mdew_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_menu_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_menu_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_menu_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_menudock_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_menudock_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_menudock_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_mlb_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../node_modules/vue-style-loader!../node_modules/css-loader/dist/cjs.js!../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../node_modules/sass-loader/lib/loader.js!../node_modules/vue-loader/lib??vue-loader-options!./mlb.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/mlb.vue?vue&type=style&index=0&lang=scss&");
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_mlb_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_mlb_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_mlb_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_mlb_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_mlb_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_modal_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_modal_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_modal_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_pop_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_pop_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_pop_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
window.addEventListener('message', function (ev) {
  ...
  if (request && repWins[ev.source.name]) {
...
module.exports = {
  unique: function unique(actTag) {
    //Return a unique tag, based on the base report tag
    for (var i = 0; true; i++) {
      var repTag = actTag + ':u' + i;
      if (!(repTag in repWins)) return repTag;
    }
  },

  register: function register(repTag, cb) {
    //Register a callack for the specified report tag
    if (cb) repWins[repTag] = cb;else delete repWins[repTag];
  }
};
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_report_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_report_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_report_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_strdoc_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_strdoc_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_strdoc_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_svgnode_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_svgnode_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_svgnode_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_svgraph_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_svgraph_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_svgraph_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }(); //Manage communication to/from the toplevel window for generating dialogs and reports
//Copyright WyattERP.org: See LICENSE in the root of this package
// -----------------------------------------------------------------------------
...
var _repcom = __webpack_require__(/*! ./repcom.js */ "./src/repcom.js");

var _repcom2 = _interopRequireDefault(_repcom);
...
module.exports = function topHandler(context) {
  ...
  this.dewArray = function (arg1, arg2) {
    ...
    if (Array.isArray(arg1)) {
      ...
      arg1.forEach(function (el) {
        ...
        if (!style) style = arg3;
        retArr.push({ field: field, lang: _this.wmCheck(lang), styles: { style: style, focus: focus } });
        focus = false;
      });
    }
    ...
    if (typeof msg == 'string') {
      ...
      //        return msg.lang
      else if (msg.message) return msg.message;else if (msg.code) return this.context.wm.winUnCode.title + ": " + msg.code;else return this.makeMessage('!winUnknown');
    } else return msg;
  };
  ...
  this.input = function (lang, cb, defVal) {
    ...
    var data = { value: defVal },
        dews = [{ field: 'value', lang: lang, styles: { style: 'ent', focus: true } }];
  ...
  this.actionLaunch = function (view, action, info, editCB) {
    var _this2 = this;
    ...
    var buttonTag = info.buttonTag,
      ...
      //Try to get keys from callback, or fall back to key value in info
      var fromFunc = typeof editCB == 'function' ? editCB() : null;
      return fromFunc || info.keys;
    },
        repTag = dialogIndex != null ? actTag + ':' + dialogIndex : action.single ? actTag : _repcom2.default.unique(actTag),
        config = { repTag: repTag, view: view, action: action, info: info //Will save this for restore purposes
    };
    ...
    var perform = function perform(target, message, win) {
      ...
      if (target == 'report') {
        ...
        _this2.context.repBus.notify(repTag, request, data);
      } else if (target == 'control') {
        var _request = data;
        _wyseman2.default.request(repTag, 'action', { view: view, name: name, data: { request: _request, options: options, keys: getKeys() } }, function (content, error) {
          //console.log("DB answers:", content, "error:", error)
          if (error) {
            _this2.error(error);return;
          }
          if (win && content) win.postMessage({ request: 'populate', format: action.format, content: content, config: config }, location.origin); //send content to report window
        });
    ...
    if (action.format) {
      ...
      _repcom2.default.register(repTag, perform);
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_win_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_win_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_less_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_win_vue_vue_type_style_index_0_lang_less___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
var Wyseman = {
  ...
  connect: function connect(authConfig) {
    var _this = this;
    ...
    this.socket.addEventListener('open', function (event) {
      ...
      _this.socket.addEventListener('message', function (ev) {
        ...
        if (data && (action == 'meta' || action == 'lang')) {
          ...
          _local2.default.set(index, data); //Save also to browser cache
    ...
    if (!this.address || this.address == '') {
      ...
      if (action != 'connect') {
        ...
        if (this.localCache[idx]) {
          ...
          data = this.localCache[idx] = _local2.default.get(idx);
        }
